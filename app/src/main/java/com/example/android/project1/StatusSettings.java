...
public class StatusSettings extends ActionBarActivity implements AdapterView.OnItemSelectedListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_status_settings, menu);
        return true;
    }
